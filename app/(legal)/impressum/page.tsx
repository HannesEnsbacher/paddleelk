...
export default function Impressum() {
    return (
        <div className="max-w-5xl mx-auto p-6">
            ...
            <p className="mb-2">Email: <Link href="mailto:contactpaddleelk@gmail.com"
                                             className="text-primary hover:underline">contactpaddleelk@gmail.com</Link>
            </p>
            ...
            <p className="mb-2">This is a private website and does not pursue any commercial interests. The owner of
                this website is
                not responsible for external links or their content.</p>

            <h2 className="text-2xl font-semibold mt-6 mb-4">Copyright</h2>
            <p className="mb-4">All content on this website is subject to copyright. Any unauthorized use is
                prohibited.</p>
